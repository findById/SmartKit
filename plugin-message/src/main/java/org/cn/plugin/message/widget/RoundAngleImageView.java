package org.cn.plugin.message.widget;
...
public class RoundAngleImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        roundWidth = dipToPixels(context, 36);
        roundHeight = dipToPixels(context, 36);
    ...
    public void draw(Canvas canvas) {
        Bitmap bitmap = Bitmap.createBitmap(getWidth() > 0 ? getWidth() : 1, getHeight() > 0 ? getHeight() : 1, Config.ARGB_8888);
